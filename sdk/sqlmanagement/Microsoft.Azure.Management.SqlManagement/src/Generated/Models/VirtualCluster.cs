...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class VirtualCluster : TrackedResource
    {
        ...
        /// cluster.</param>
        /// <param name="maintenancePolicyId">Specifies maintenance policy id
        /// to apply to this virtual cluster.</param>
        public VirtualCluster(string location, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string subnetId = default(string), string family = default(string), IList<string> childResources = default(IList<string>), string maintenancePolicyId = default(string))
        ...
        /// <summary>
        /// Gets or sets specifies maintenance policy id to apply to this
        /// virtual cluster.
        /// </summary>
        [JsonProperty(PropertyName = "properties.maintenancePolicyId")]
        public string MaintenancePolicyId { get; set; }
